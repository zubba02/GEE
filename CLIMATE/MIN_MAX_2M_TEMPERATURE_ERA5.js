...
var islandSelect = ui.Select({
  items : [
    ...
    */
    ...
    .setOptions({
          title: 'Minimum daily tempperature across '+value+' atoll from '+start+' to '+end,
          hAxis: {title: 'Time'},
    ...
    .setOptions({
          title: 'Maximum daily tempperature across '+value+' atoll from '+start+' to '+end,
          hAxis: {title: 'Time'},
          vAxis: {title: 'Temperature (Celcius)'}
    });
    ...
    .setOptions({
          title: 'Mean daily tempperature across '+value+' atoll from '+start+' to '+end,
          hAxis: {title: 'Time'},
          vAxis: {title: 'Temperature (Celcius)'}
    });
