...
var islandSelect = ui.Select({
  items : [
    ...
    var prec = era5_2mt_c_to_k.filterBounds(selected_atoll).filter(ee.Filter.date('1980-01-01', '2019-12-31')).select('total_precipitation');
    ...
    .setOptions({
          title: 'Monthly daily tempperature across '+value+' atoll from '+start+' to '+end,
          hAxis: {title: 'Time'},
          vAxis: {title: 'Temperature (mm)'}
    });
