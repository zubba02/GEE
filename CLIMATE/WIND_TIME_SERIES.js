...
var selectStartYear = ui.Textbox({placeholder: 'Start',  value: '1980-01-01',
  style: {width: '100px'}}); 
...
var Mean = ui.Button({
  ...
  onClick: function() {
    ...
    var label = ui.Label('Mean wind magnitude and wind vectors during the period '+start+' to '+end);
    Map.add(label);
