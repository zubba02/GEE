...
panel.add(ui.Label({value: 'Select the start and end dates (YYYY-MM-DD) to plot time series of Precipitation .',
  style: {
    fontWeight: 'normal',
    fontSize: '15px',
    margin: '0 0 4px 0',
...
var selectStartYear = ui.Textbox({placeholder: 'Start',  value: '2002-01-01',
  style: {width: '100px'}}); 
...
var TS2 = (
  ui.Chart.image.series({
    ...
    scale: 1000
  }).setOptions({title: 'Time series of monthly SST across '+value+' from '+startDate_val+' to '+endDate_val})
);
...
var chartDaily = (
  ui.Chart.image.doySeriesByYear({
    ...
    scale: 1000
  }).setOptions({title: 'SST variance across '+value+' from '+startDate_val+' to '+endDate_val})
);
