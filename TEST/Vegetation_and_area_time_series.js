...
panel.add(ui.Label({value: 'Select your region in the form of Atoll.Island from the drop down menu to plot the island area over time and the area of vegetaion over time for the island. A second graph shows the percentage of vegetation across the island for the durtion.)',
  style: {
    fontWeight: 'normal',
    fontSize: '15px',
    margin: '0 0 4px 0',
